...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="3%" align="center"><br>      <br></td>
    <td width="94%" align="left">      <a href="previewcampaign.php?id=<?php echo $id;?>&new=yes" class="mainmenu"><strong>Preview Campaign</strong></a> | <a href="editadst.php?id=<?php echo $id;?>&action=activate&new=yes" class="mainmenu"><strong>Activate Campaign</strong></a> </td>
