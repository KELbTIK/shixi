...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="95%"><br><br>
     ...
     The campaign is <span class="already">pending</span> and you can manage it from the 'pending campaign' area. <br>
     <br>     </td>
  ...
  <tr>
    <td><a href="attach.php?id=<?php echo $id?>&new=yes" class="mainmenu"><strong>Attach Files</strong></a> | <a href="previewcampaign.php?id=<?php echo $id;?>&new=yes" class="mainmenu"><strong>Preview Campaign</strong></a> | <a href="editadst.php?id=<?php echo $id;?>&action=activate&new=yes" class="mainmenu"><strong>Activate Campaign</strong></a> </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
