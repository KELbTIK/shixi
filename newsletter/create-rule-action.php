...
exit(0);
	...
	{
	if(mysql_query("insert into  ".$table_prefix."bmh_rules  (`id`,`type`,`pattern`,`email_index`) values  ('0','$bmh_type','$bmh_rule','$email_index')"))
		{
		...
		{
		 include("admin.header.inc.php");
	echo "<br><strong>An error occured please go back and verify the data .</strong><br><br><a href=\"javascript:history.back(-1);\">Go Back</a> ";
	include("admin.footer.inc.php");
exit(0);
		}
	}
