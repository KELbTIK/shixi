	 ...
	 if(isset($_COOKIE['inout_sub_admin']))
				{
				 ...
				 mysql_query("insert into ".$table_prefix."admin_log_info values('','$aid','$adminname attempted unauthorized access to create bmh rule','".time()."','$CST_MLM_ADMIN_MANAGEMENT')");
...
<br>
<form action="create-rule-action.php" method="post" enctype="multipart/form-data" name="form1" onsubmit="return checkNull();">
...
<tr>
<td><select name="bmh_type">
<option value="2" >Body</option>
<option value="1" >DSN</option>
</select></td>
<td><input type="text" size="70" value="" name="bmh_rule"/></td>
<td> <input type="text"  value="" name="email_index"/></td>
<td > <input type="submit" name="submit" value="Create rule" /></td>
</tr>
...
<tr>
  <td colspan="2">eg: /Delivery to the following recipient failed permanently:(.+?)(\S+@\S+\w)/is</td>
  <td></td>
  <td ></td>
</tr>
<tr>
...
<tr>
<td colspan="2"><strong>Email Index</strong> is needed only for Body rules.</td>
<td> </td>
<td > </td>
</tr>
</table>
