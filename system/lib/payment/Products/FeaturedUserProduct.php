...
class SJB_FeaturedUserProduct extends SJB_ProductDetails 
{
	...
	public static function getPages()
	{
		return array(
			'general' => array(
				...
				'fields' => array('name', 'short_description', 'detailed_description', 'active', 'availability_from', 'availability_to', 'trial', 'welcome_email')
			),
			'pricing' => array(
				'name' => 'Pricing',
