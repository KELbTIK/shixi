	...
	<div id="headerPage">
		...
		<div id="userMenu">
			{if $GLOBALS.current_user.logged_in}
				[[Welcome]] <span class="longtext-35">{if $GLOBALS.current_user.subuser}{$GLOBALS.current_user.subuser.username}{else}{$GLOBALS.current_user.username}{/if}</span>, &nbsp;
				{if $GLOBALS.current_user.new_messages > 0}
					...
					{/if}
				{/if}
				<a href="{$GLOBALS.site_url}/"> [[Home]]</a> &nbsp; <a href="{$GLOBALS.site_url}/logout/"> [[Logout]]</a>
			{else}
				<a href="{$GLOBALS.site_url}/"> [[Home]]</a> &nbsp; <a href="{$GLOBALS.site_url}/registration/"> [[Register]]</a> &nbsp; <a href="{$GLOBALS.site_url}/login/"> [[Sign In]]</a><br/>
