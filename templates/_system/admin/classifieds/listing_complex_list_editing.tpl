		...
		<table>
			<tr>
				...
				<td>
					...
					<textarea name="list_multiItem_value" style="display:none"></textarea> <span class="required">*</span>
				</td>
				<td>
	...
	<table id="list_table">
		...
		{foreach from=$list_items item=list_value key=sid name=items_block}
			<tr class="{cycle values = 'evenrow,oddrow' advance=false}">
				...
				<td><a href="{$GLOBALS.site_url}/edit-listing-field/edit-fields/edit-list-item/?field_sid={$field_sid}&amp;item_sid={$sid}" title="[[Edit]]" class="editbutton">[[Edit]]</a></td>
...
<script type="text/javascript" src="{$GLOBALS.user_site_url}/system/ext/jquery/jquery.tablednd.js"></script>
