...
<div style="min-height: 26px;">
	...
	<select multiple="multiple" style="display: none;" class="inputList fieldType{$id} {if $sort_by_alphabet}sortable-select{/if} {if $complexField}complexField{/if}" name="{if $complexField}{$complexField}[{$id}][{$complexStep}][]{else}{$id}[]{/if}">
