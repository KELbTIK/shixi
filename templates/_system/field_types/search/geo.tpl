{capture name="select_box_field_distance"}
	<select class="searchGeoDistance form-control" name="{$id}[geo][radius]">
...
{capture name="input_text_field_location"}   
	<input type="text" class="searchGeoLocation form-control" id="{$id}" name="{$id}[geo][location]" value="{$value.location}" />
{/capture}
